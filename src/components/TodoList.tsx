...
import { CalendarDays, CheckCircle2, Flag, ListTodo, Plus, Search, Tag, Trash2 } from "lucide-react";
...
return (
    <div className="relative flex h-full items-start overflow-hidden">
      ...
      <main className="relative w-full space-y-4">
        <header className="rounded-2xl border border-border/80 bg-card/80 p-4 shadow-lg backdrop-blur-sm">
          <div className="space-y-1">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Task board</p>
            <h1 className="text-2xl font-bold text-foreground sm:text-3xl">My Todos</h1>
